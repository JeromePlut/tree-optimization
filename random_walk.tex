...
&= ∑_{k=1}^{b-1}
	\frac{\frac 1b (-1)^{k-1} \sin\frac{jkπ}{b} \tan\frac{kπ}{b}}
		{1-2x\cos\frac{kπ}{b}} + \Re(i^{b-j})\\
% N_{s,b,ℓ}
% &= [z^0] F_{s,b} + [z^0] F_{b-s,b}\\
% &= ∑_{k=1}^{b-1}\frac{\frac 1b \sin \frac{jkπ}{b}
% \tan \frac{kπ}{b}}{1-2x\cos\frac{kπ}{b}}
% + ∑_{k=1}^{b-1}\frac{\frac 1b \sin\pa{j
% + i^j \frac{1+(-1)^j-(iz)^b+(-1)^j(iz)^b}{2}
\end{align}
% For $b → ∞$ we have:
% \begin{align}
% \frac 1b \tan \frac{kπ}{b} \sin\frac{jkπ}{b}
% 	&= \frac{jk^2π^2}{b^3} + O(b^{-5});\\
% \frac{1}{1-2x \cos \frac{kπ}{b}}
%  &= \frac{1}{1-2x} - \frac{x k^2 π^2}{(1-2x)^2} \frac{1}{b^2} +
%  O(b^{-4});\\
% \frac{1}{1-2z \cos \frac{kπ}{b} + z^2}
% 	&= \frac{1}{(1-z)^2} - \frac{z k^2 π^2}{(1-z)^4} \frac{1}{b^2} +
% 	O(b^{-4});\\
% \end{align}
% hence
% \begin{align}
% F_{j,b} &=
% ∑_{k=1}^{b-1} \frac{jk^2 π^2}{b^3}
% 	(1-(-1)^k z^b)(1+z^2)
% 	\frac{1}{1-2x} \frac{1}{(1-z)^2} \pa{1+O(b^{-2})} + …
% \end{align}
